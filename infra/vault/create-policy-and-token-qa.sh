...
#   2. Creates ACL policy "f1-config-server-components-management-portal-qa"
...
#
# Usage:
#   VAULT_ADDR=https://vault.example.com VAULT_TOKEN=<admin-token> ./infra/vault/create-policy-and-token-qa.sh
#
...
POLICY_NAME="f1-config-server-components-management-portal-qa"
POLICY_FILE="$(dirname "$0")/f1-config-server-components-management-portal-qa.hcl"
...
echo "     f1-config-server-deployment/tokens/components-management-portal-qa-token"
echo "     f1-config-server-deployment/tokens/components-management-portal-qa-token-accessor"
echo ""
echo "  2. Create OKD secret:"
echo "     oc create secret generic components-management-portal-cloud-qa -n f1 \\"
