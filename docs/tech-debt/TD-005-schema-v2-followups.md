...
- **Wave 0 — OpenAPI codegen** (commits `e2e2199`, `2070c9e`) — `openapi-typescript` against a vendored `v4.json`; drift check via `npm run generate-types:check`. **Done + verified** (zero drift vs hand-rolled `types.ts`).
