 ...
 *
 * `solutionKeyPatterns` drives the conditional "Solution" toggle on the General
 * tab: the SPA shows the solution/not-solution switch only for a component whose
